...
if("TRUE" STREQUAL "TRUE")
  set(lattice_planner_SOURCE_PREFIX /home/hriclass/yt542_ws/src/lattice_planner)
  set(lattice_planner_DEVEL_PREFIX /home/hriclass/yt542_ws/devel)
  ...
  set(lattice_planner_INSTALL_PREFIX /home/hriclass/yt542_ws/install)
...
if(NOT "/home/hriclass/yt542_ws/devel/include;/home/hriclass/yt542_ws/src/lattice_planner/include " STREQUAL " ")
  set(lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/hriclass/yt542_ws/devel/include;/home/hriclass/yt542_ws/src/lattice_planner/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Marina Kollmitz <marinakollmitz@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hriclass/yt542_ws/src/lattice_planner/${idir}'.  Ask the maintainer 'Marina Kollmitz <marinakollmitz@gmail.com>' to fix it.")
    endif()
...
set(lattice_planner_EXPORTED_TARGETS "lattice_planner_generate_messages_cpp;lattice_planner_generate_messages_lisp;lattice_planner_generate_messages_py")
