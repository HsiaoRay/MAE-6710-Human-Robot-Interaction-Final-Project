...
if("TRUE" STREQUAL "TRUE")
  set(sphero_node_SOURCE_PREFIX /home/hriclass/yt542_ws/src/sphero_ros/sphero_node)
  set(sphero_node_DEVEL_PREFIX /home/hriclass/yt542_ws/devel)
  ...
  set(sphero_node_INSTALL_PREFIX /home/hriclass/yt542_ws/install)
...
if(NOT "/home/hriclass/yt542_ws/devel/include " STREQUAL " ")
  set(sphero_node_INCLUDE_DIRS "")
  set(_include_dirs "/home/hriclass/yt542_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'sphero_node' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Melonee Wise <melonee@meloneewise.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'sphero_node' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hriclass/yt542_ws/src/sphero_ros/sphero_node/${idir}'.  Ask the maintainer 'Melonee Wise <melonee@meloneewise.com>' to fix it.")
    endif()
...
set(sphero_node_EXPORTED_TARGETS "sphero_node_generate_messages_cpp;sphero_node_generate_messages_lisp;sphero_node_generate_messages_py;sphero_node_gencfg")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${sphero_node_dep}_FOUND)
      find_package(${sphero_node_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${sphero_node_dep} REQUIRED ${depend_list})
  endif()
